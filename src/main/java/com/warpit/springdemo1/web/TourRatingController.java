package com.warpit.springdemo1.web;
...
import com.warpit.springdemo1.repo.TourRatingRepository;
 ...
 */
@RestController
@RequestMapping(path = "/tours/{tourId}/ratings")  //rating is always associated with one tour
